   ...
   # --- 6. RUN BENCHMARKS ---
    ...
    > /home/ngetty/proj/vllm_gpt-oss/Aurora-Inferencing/cluster_scaling/bench_tp8_tp4/bench_8080.log 2>&1 &
    BENCH_PIDS+=($!)
    ...
    --random-input-len $INPUT_LEN \
    --random-output-len $OUTPUT_LEN \
    > /home/ngetty/proj/vllm_gpt-oss/Aurora-Inferencing/cluster_scaling/bench_tp8_tp4/bench_8081.log 2>&1 &
    BENCH_PIDS+=($!)
